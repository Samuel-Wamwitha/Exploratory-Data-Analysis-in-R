...
The solution can be challenged by performing Logistic regression to enable the client to predict on which people are likely to click the advert about her business.
